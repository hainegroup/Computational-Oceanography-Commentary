...
% See: supercomputer_history.numbers
...
for ee = 1:length(supercomputerhistory.times)
    ...
    supercomputerhistory.Speed_flops(ee) = supercomputerhistory.Speed_flops(ee)*multiplier ;    % These are Rmax numbers after 1980
end % ee
...
supercomputerhistory.color = [0.4940 0.1840 0.5560] ;
