...
curl -u 'hainegroup' https://api.github.com/user/repos -d '{"name":"computational_oceanography_commentary", "private":false}'
...
git remote add origin git@github.com:hainegroup/computational_oceanography_commentary.git
